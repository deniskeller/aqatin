        ...
        <BaseContainer>
          ...
          <div className={styles.Header}>
            ...
            <div className={styles.Header_Description}>
              ...
              <br />
              <BaseText color="#000">It is safe, fast and convenient!</BaseText>
              <br />
              <BaseText color="#000">
                Just add the Aqatin card to your device and pay with one touch.
                There are no payment amount limits and great number of countries
